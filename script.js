// Typing effect
const text = ["BCA Student", "Web Developer", "Tech Enthusiast", "Drawing Lover"];
...
// Profile Photo Upload and Save to localStorage
...
// Load saved profile photo from localStorage on page load
